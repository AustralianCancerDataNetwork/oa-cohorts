...
> **Superseded from 0.8.7 onward.** Release notes are now generated by release-drafter from merged PR titles and published on the
> [Releases page](https://github.com/AustralianCancerDataNetwork/oa-cohorts/releases).
>
> This file is kept as the historical record up to 0.8.7 and is no longer updated by hand.
